  ...
  return (
    <Html lang={locale}>
      <Head>
        ...
        {/* Google Fonts — DM Sans (primary) + Montserrat/Open Sans (legacy pages) */}
        <link
          href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Montserrat:wght@400;500;600;700;800&family=Open+Sans:wght@300;400;500;600;700&display=swap"
          rel="stylesheet"
        />
