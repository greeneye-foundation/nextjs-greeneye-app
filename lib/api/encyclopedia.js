...
export const articlesAPI = {
  ...
  getBySlug: async (slug, language = 'en') => {
    return apiRequest(`/articles/${slug}?language=${language}`);
  },
...
export const mediaAPI = {
  ...
  // Upload media for article
  upload: async (articleSlug, formData) => {
    const url = `${API_BASE_URL}/api/encyclopedia/media/article/${articleSlug}`;
